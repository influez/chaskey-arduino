/*
   ...
   Modified in 2021 by E to print result in Hex
...
void printHex(const unsigned char *data, int size)
{
  ...
  for (i = 0; i < 64; i++) {
	...
	printf("Chaskey8 Result		: "); printHex(tag, 8); printf("\n");
    printf("Test Vector Result	: "); printHex(vectors[i], 8); printf("\n");
...
int main() {
  if (test_vectors()) printf("TEST VECTOR SUCCESS\n");
